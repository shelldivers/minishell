...
EXEC += ms_exec.c ms_exec_utils.c ms_exec_init_clear.c ms_exec_words.c ms_exec_path.c ms_exec_fd.c ms_quote_removal.c \
...
EXPAND += ms_expand.c ms_expand_utils.c ms_queue.c ms_queue_utils.c ms_glob.c ms_glob_utils.c \
